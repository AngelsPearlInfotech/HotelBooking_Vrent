...
class SearchController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       // $map_where = 'https://maps.google.com/maps/api/geocode/json?key=' . MAP_KEY . '&address=' . $address . '&sensor=false';
        $map_where = 'https://maps.google.com/maps/api/geocode/json?key=' ."AIzaSyAUevXmCBPElE-UiPcZW77KpuckXZ_iWRc". '&address=' . $address . '&sensor=false';
    ...
    function searchResult(Request $request)
    {
       ...
       // $map_where = 'https://maps.google.com/maps/api/geocode/json?key=' . MAP_KEY . '&address=' . $address . '&sensor=false&libraries=places';
        $map_where = 'https://maps.google.com/maps/api/geocode/json?key=' . "AIzaSyAUevXmCBPElE-UiPcZW77KpuckXZ_iWRc" . '&address=' . $address . '&sensor=false&libraries=places';
