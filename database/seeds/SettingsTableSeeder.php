...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
            ...
            ['name' => 'client_id', 'value' => '396445384655-hiae28u7u4lj369sidn7skld0jajf2ln.apps.googleusercontent.com', 'type' => 'google'],
            ['name' => 'client_secret', 'value' => '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', 'type' => 'google'],
