...
@section('emails.main')
 ...
 <div class="card">
  <div class="card-header pt-3 pb-4">
    <strong class="font-weight-700">Customer Receipt</strong>
    <span class="float-right"> <strong class="font-weight-700">Confirmation Code :</strong> {{ $booking->code }}</span>
  </div>
  <div class="card-body pt-0 pb-0 pl-4 pr-4">
    <div class="row mb-4 mt-5">
     ...
     <!-- <div class="col-md-6 print-div text-right p-0" id="print-div">
      ...
      <a href="{{route('user.dashboard')}}"  class="btn vbtn-outline-success text-14 font-weight-700 pt-2 pb-2 ml-2 mt-2 pl-3 pr-4 button" style="float: right;">back</a> -->
  ...
  <div class="row">
    <div class="col-md-6 col-sm-6 col-xs-12 mt-3 ow rpt pl-0">
      <div class="p-0">
        <span> <strong class="font-weight-700 text-18">Name :</strong> {{ $booking->users->full_name }}</span>
      </div>
    </div>
  ...
  <div class="row rpt border pt-3 mb-5 mt-2">
    <div class="col-md-3 col-sm-3 col-xs-12"><!-- card pt-4 mb-5 mt-2 rounded-3 -->
      <h4 class="margin-top20"><strong>Accommodation Address</strong></h4>
      ...
      <div class="col-md-3 col-sm-3 col-xs-12">
        <h4><strong>Travel Destination</strong></h4>
        <h5 class="margin-top20">{{ @$booking->properties->property_address->city }}</h5>
        <h4 class="margin-top20"><strong>Accommodation Host</strong></h4>
      ...
      <div class="col-md-3 col-sm-3 col-xs-12">
        ...
        <h4 class="margin-top20"><strong>Check In</strong></h4>
      ...
      <div class="col-md-3 col-sm-3 col-xs-12">
        ...
        <h4 class="margin-top20"><strong>Check Out</strong></h4>
    ...
    <div class="table-responsive mt-3">
      <table class="table table-bordered table-hover p-0 m-0">
        <thead class="thead-dark">
          <tr>
            <th colspan="6">Booking Charges</th>
          </tr>
        </thead>
        <tbody class="border">
          @if($date_price)
