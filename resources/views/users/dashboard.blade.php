														...
														@endif
															 <tbody id="transaction-table-body1">
																@foreach($transactions as $transaction)
																	<tr>
																	 <td>
																		{{ $transaction->type > 0 ? trans('messages.users_dashboard.booking') : ($transaction->type < 0 ? trans('messages.users_dashboard.trip') : trans('messages.users_dashboard.withdraw'))}}
                                                                        </td>
