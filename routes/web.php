...
Route::group(['middleware' => ['guest:users', 'locale']], function () {
   ...
   // Route::get('googleAuthenticate', 'LoginController@googleAuthenticate');
	...
	Route::post('payments/payment_checkout', 'PaymentController@payment_checkout')->name('payment.checkout');
    Route::post('payments/create_booking', 'PaymentController@createBooking')->name('create.booking');
	...
	Route::get('booking/sendreceipt', 'TripsController@sendreceipt');
